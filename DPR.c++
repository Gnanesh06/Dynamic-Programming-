...
+ 1, n, m);
// Return the maximum and store the value return gold[x][y] +
max(max(rightUpperDiagonal,
...
int goldCollected = collectGold(gold, i, 0, n,maxGold = max(maxGold,
goldCollected);
10
return maxGold;
}
...
int m = 4, n = 4;
cout << getMaxGold(gold, n, m);return 0;
}
